...
function generateTableRow() {
    ...
    emptyColumn.innerHTML = '' +
        ...
        '<td><input type="number" id="productId" name="productId" min="0" max="9999" placeholder="0"></td>' +
        '<td><input type="number" id="price" name="price" min="0" max="9999" placeholder="$0.00"></td>' +
        '<td><input type="number" id="quantity" name="quantity" min="0" max="9999" placeholder="0"></td>';
    if (item % 2 != 0) {
...
function onContentLoad() {
    ...
    function onClick(e) {
        ...
        if (e.target.matchesSelector('.add')) {
            document.querySelector('table.orderList tbody').appendChild(generateTableRow());
        }
